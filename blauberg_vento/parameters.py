...
PARAM_META: dict[Param, ParamMeta] = {
    Param.POWER: {
        "func": _READ_WRITE,
        "size": 1,
        "not_a30": False,
        "desc": "Unit On/Off",
        "values": {0: "Off", 1: "On", 2: "Invert"},
        "range": None,
    },
    Param.SPEED: {
        "func": _READ_WRITE_INC_DEC,
        "size": 1,
        "not_a30": False,
        "desc": "Speed number",
        "values": {1: "Speed 1", 2: "Speed 2", 3: "Speed 3", 255: "Manual"},
        "range": None,
    },
    Param.BOOST_STATUS: {
        "func": _READ_ONLY,
    ...
    Param.FILTER_INDICATOR: {
        ...
        "size": 1,
        "not_a30": False,
        "desc": "Filter indicator",
        "values": {0: "OK", 1: "Replace"},
        "range": None,
    },
    Param.BOOST_DELAY: {
        "func": _READ_WRITE_INC_DEC,
    ...
    Param.ALARM_STATUS: {
        ...
        "not_a30": False,
        "desc": "Alarm status",
        "values": {0: "No alarm", 1: "Alarm", 2: "Warning"},
        "range": None,
    },
    ...
    Param.WIFI_ENCRYPTION: {
        ...
        "size": 1,
        "not_a30": False,
        "desc": "Wi-Fi encryption",
        "values": {48: "OPEN", 50: "WPA_PSK", 51: "WPA2_PSK", 52: "WPA_WPA2_PSK"},
        "range": None,
    },
    Param.WIFI_CHANNEL: {
        "func": _READ_WRITE_INC_DEC,
    ...
    Param.WIFI_DHCP: {
        ...
        "not_a30": False,
        "desc": "Wi-Fi DHCP",
        "values": {0: "Static", 1: "DHCP", 2: "Invert"},
        "range": None,
    },
    Param.WIFI_IP: {
        "func": _READ_WRITE,
    ...
    Param.OPERATION_MODE: {
        ...
        "not_a30": False,
        "desc": "Operation mode",
        "values": {0: "Ventilation", 1: "Heat Recovery", 2: "Supply"},
        "range": None,
    },
    Param.UNIT_TYPE: {
        "func": _READ_ONLY,
        ...
        "not_a30": False,
        "desc": "Unit type",
        "values": {3: "A50/A85/A100 V.2", 4: "Duo A30 V.2", 5: "A30 V.2"},
        "range": None,
    },
    Param.NIGHT_TIMER: {
        "func": _READ_WRITE,
